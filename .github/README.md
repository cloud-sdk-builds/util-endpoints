...
[`@aws-sdk/util-endpoints`](https://www.npmjs.com/package/@aws-sdk/util-endpoints/v/3.996.17).
...
- @aws-sdk/util-endpoints - [https://cloud-sdk-builds.github.io/?sdk=util-endpoints](https://cloud-sdk-builds.github.io/?sdk=util-endpoints)
- @aws-sdk/util-endpoints v3.996.17 - [https://cloud-sdk-builds.github.io/?sdk=util-endpoints&version=3.996.17](https://cloud-sdk-builds.github.io/?sdk=util-endpoints&version=3.996.17)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/util-endpoints@3.996.17/index.min.mjs
```

SRI SHA Hash

```text
sha384-hxw7UPqDWaV/BgqBMdIw2YpuOhI9FnZ1dlkAWq8zKabYmAsPT0vtti2UEyQhI+5u
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/util-endpoints/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/util-endpoints": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/util-endpoints@3.996.17/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/util-endpoints@3.996.17/index.min.mjs": "sha384-hxw7UPqDWaV/BgqBMdIw2YpuOhI9FnZ1dlkAWq8zKabYmAsPT0vtti2UEyQhI+5u"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/util-endpoints";
...
```
https://github.com/cloud-sdk-builds/util-endpoints/blob/refs/tags/3.996.17/LICENSE
```
